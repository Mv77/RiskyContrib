...
plt.figure()
plt.plot(AgeMeans.Age, AgeMeans.pLvl,
         label = 'Permanent Income')
plt.plot(AgeMeans.Age, AgeMeans.m,
         label = 'Liquid riskless')
plt.plot(AgeMeans.Age, AgeMeans.n,
         label = 'Iliquid risky')
plt.plot(AgeMeans.Age, AgeMeans.c,
         label = 'Consumption')
plt.legend()
plt.xlabel('Age')
...
plt.figure()
plt.plot(AgeMeans.Age, AgeMeans.StockShare,
         label = 'Risky share of savings')
plt.plot(AgeMeans.Age, AgeMeans.Share,
